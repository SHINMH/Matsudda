...
public class MainPanel extends JPanel {
   ...
   class MainListener implements MouseListener {
      public void mouseClicked(MouseEvent event) {
         ...
         } else if (obj == Explanation) { //게임설명 버튼 클릭 시
            ExplanationPanel.setVisible(true);
            start.setVisible(false);
            Explanation.setVisible(false);
            finish.setVisible(false);
         } else if (obj == finish) { //게임종료 버튼 클릭 시
            System.exit(0);
         } else if (obj == ExplanationPanel.backbtn) { //ExplanationPanel에서 돌아가기버튼 클릭 시
            ExplanationPanel.setVisible(false);
            start.setVisible(true);
            Explanation.setVisible(true);
            finish.setVisible(true);
         } else if (obj == startPanel.backbtn) { //startPanel에서 돌아가기버튼 클릭 시
            startPanel.setVisible(false);
            start.setVisible(true);
            Explanation.setVisible(true);
            finish.setVisible(true);
