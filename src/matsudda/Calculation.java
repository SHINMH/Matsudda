...
public class Calculation {
   ...
   public Calculation(int p1, int p2) { //카드 패의 조합에 따른 순위로 변환하여 저장.
      if (p1 > p2) {
         int temp;
   ...
   public int winner(Calculation com) { //양 플레이어의 조합에 따라 승리자를 반환하는 함수 1,유저 2,컵퓨터 3,무승부
      // 임시로 승리면 1 패배면 2 출력
      // 재경기 3
   ...
   public int ComputerChioce(Calculation com, int playerPick) { // 컴퓨터의 배팅을 정하는 메쏘드
